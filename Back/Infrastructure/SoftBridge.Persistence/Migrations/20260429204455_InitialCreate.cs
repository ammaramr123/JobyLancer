        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfileImageUrl = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: true),
                    CvUrl = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: true),
                    PortfolioLink = table.Column<string>(type: "nvarchar(750)", maxLength: 750, nullable: true),
                    ...
                    ApproveByAdminId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Providers_AverageRating", "[AverageRating] BETWEEN 0 AND 5");
                    table.CheckConstraint("CK_Providers_TotalReviews", "[TotalReviews] >= 0");
                    table.ForeignKey(
                        name: "FK_Providers_AspNetUsers_ApproveByAdminId",
                        column: x => x.ApproveByAdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPortfolio = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Providers_ApproveByAdminId",
                table: "Providers",
                column: "ApproveByAdminId");
